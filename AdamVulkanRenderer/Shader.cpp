...
bool Shader::GLSLtoSPV(const VkShaderStageFlagBits shader_type, const char *pshader, std::vector<unsigned int> &spirv)
{
...
void Shader::InitShaderResources(TBuiltInResource &Resources) 
{
